...
<div class="container-fluid">
    <div class="row d-flex justify-content-end mb-2">
        <div class="col-12">
            <a href="{{ route('admin.berita.detail') }}" class="btn btn-primary"><i class="ri-add-line"></i> Tambah Berita</a>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
                ...
                },
                {
                    ...
                    mRender: function(data, type, row) {
                        ...
                        <div class="btn-group btn-group-sm gap-2" role="group" aria-label="Small button group">
                            <a href="{{ route('admin.berita.detail') }}?slug=${row.slug}" class="btn btn-warning edit" data-toggle="tooltip" data-placement="top" title="Edit Item"><i class="ri-edit-2-line"></i></a>
