                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="profile-container">
                                    <img src="{{ asset('assets/img/icon-img.png') }}" alt="Ikon" class="img-fluid" id="iconPict">
                                    <div class="overlay-me">
                                        <div class="camera-icon">
                                            <i class="ri-camera-line"></i>
                                            <span class="tooltip-me">Upload Ikon</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-9 pl-4">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    <div class="col-sm-11">
                                                        <input type="text" name="title" id="title" class="form-control" style="border-radius:5px;" placeholder="Judul Layanan">
                                                        <div class="invalid-feedback">Konten kosong</div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            <label class="col-sm-3">Deskripsi Singkat</label>
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    <div class="col-sm-11">
                                                        <input type="text" name="desc" id="desc" class="form-control" style="border-radius:5px;" placeholder="Deskripsi Singkat Layanan">
                                                        <div class="invalid-feedback">Konten kosong</div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    <div class="col-sm-11">
                                                        <input type="file" name="banner" id="banner" class="form-control" style="border-radius:5px;" accept="image/*">
                                                        <div class="invalid-feedback">banner kosong</div>
                                                        <div class="mt-2">
                                                            <div id="bannerPreviewContainer" class="banner-preview no-banner">
                                                                <img id="bannerPreview" src="" alt="Banner Preview">
                                                                <div id="noBannerText">Tidak ada banner untuk ditampilkan</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    <label class="text-center mb-2">Konten</label>
                                    <div class="form-group row mb-3">
                                        <div class="col-sm-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#addRecord").on('click', function() {
                ...
                const bannerFile = $("#banner")[0].files[0];
                        ...
                        400: function(xhr) {
                            ...
                            if(res.message) {
                                if(res.message.title) {
                                    ...
                                    $("#title").next('.invalid-feedback').text(errors.join(","));
                                    $("#title").addClass('is-invalid');
                                }
                                if(res.message.desc) {
                                    const errors = res.message.desc;
                                    $("#desc").next('.invalid-feedback').text(errors.join(","));
                                    $("#desc").addClass('is-invalid');
                                }
                                if(res.message.banner) {
                                    const errors = res.message.banner;
                                    $("#banner").next('.invalid-feedback').text(errors.join(","));
                                    $("#banner").addClass('is-invalid');
                                }
                                if(res.message.icon) {
                                    const errors = res.message.icon;
                                    Swal.fire({
                                        title: "Perhatian",
                                        text: errors.join(", "),
                                        icon: res.msg_type || 'warning'
                                ...
                                if(res.message.content) {
                                    ...
                                    $("#contentError").text(errors.join(","));
                                    $("#content").next(".note-editor").addClass('invalid-border');;
                                }
                            }
                        },
                        500: function(xhr) {
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.get(`{{ url('cms-layanan-detail') }}/${id}`, function(obj) {
                    const data = obj.data;
                    ...
                    if (data) {
                        ...
                        $("#iconPict").attr("src", data?.icon !== "" ? extractSrc(data.icon) : "{{ asset('assets/img/icon-img.png') }}");
                        $('#bannerPreview').attr('src', data.banner);
                        $('#bannerPreview').parent().removeClass('no-banner');
                        $('#noBannerText').text('');
                        $("#title").focus();
            ...
            function resetForm() {
                ...
                $('#bannerPreview').attr('src', null);
                $('#bannerPreview').parent().addClass('no-banner');
                $('#noBannerText').text('Tidak ada banner untuk ditampilkan');
                $("#addRecord").html(`<i class="ri-add-circle-line"></i> Simpan`);
            }
            ...
            function handleAjaxError(xhr) {
                ...
                if (xhr.status === 400 && res.message) {
                    // Validation errors
                    const errorFields = ['title', 'desc', 'content', 'icon', 'banner'];
