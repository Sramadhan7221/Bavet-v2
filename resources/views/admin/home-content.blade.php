                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-sm-11">
                                                <input type="text" name="subtitle" id="subtitle" class="form-control" style="border-radius:5px;">
                                                <div class="invalid-feedback">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-sm-11">
                                                <input type="text" name="yt_link" id="yt_link" class="form-control" style="border-radius:5px;">
                                                <div class="invalid-feedback">
                                                    Please choose a username.
                                                </div>
                                            </div>
